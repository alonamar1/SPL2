...
public class CameraTest {
    ...
    public List<StampedDetectedObjects> camera1Test() {
        ...
        for (int i = 2; i <= 10; i++) {
            ...
            if (i % 2 == 0) {
                camera1.get(i - 2).addDetectedObject(new DetectedObject(id1 + "1", id1));
            }
            if (i % 3 == 0) {
            ...
            if (event1 != null) {
                ...
                if (event1.getDetectedObject().get(0).getID().equals("ERROR")) {
                    ...
                    for (int j = 0; j < tempList.size(); j++) {
                        ...
                        assertTrue(tempList.get(j).getDescreption()
                                .equals(event1.getDetectedObject().get(j).getDescreption()));
                    }
                }
            }

        }
        System.out.println("test1 has finished");
    }
    ...
    public void Test2() {
        ...
        for (int i = 1; i <= detectedObjectsList2.size(); i++) {
            ...
            if (event2 != null) {
                ...
                // checks if there is indeed an error if indicated
                if (event2.getDetectedObject().size() > 0
                        && event2.getDetectedObject().get(0).getID().equals("ERROR")) {
                    boolean findError = false;
                    ...
                    for (int j = 0; j < tempList.size(); j++) {
                        // checks the strings are matched
                        assertTrue(tempList.get(j).getDescreption()
                                .equals(event2.getDetectedObject().get(j).getDescreption()));
                    }
                }
            }
        }
